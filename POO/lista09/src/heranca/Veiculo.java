...
public abstract class Veiculo {
	...
	public void exibirDados() {
		System.out.println("Veiculo [velocidadeMaxima=" + velocidadeMaxima + ", velocidadeAtual=" + velocidadeAtual + ", ligado="
				+ ligado + ", piloto=" + piloto + ", quantidade_porta=" + quantidade_porta + ", tipoVeiculo="
				+ tipoVeiculo + "]");
	}
